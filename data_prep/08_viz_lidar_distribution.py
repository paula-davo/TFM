...
ax.set_xlabel("x — profundidad (m)"); ax.set_ylabel("y — lateral (m)")
ax.set_title("Distribución de peatones en el espacio 3D")
ax.legend(loc="upper right", fontsize=9)
fig.colorbar(hb, ax=ax, label="Número de detecciones (log)")
fig.tight_layout()
...
ax.set_xlabel("Distancia al robot (m)"); ax.set_ylabel("Número de detecciones")
ax.set_title("Distribución de la distancia peatón-robot")
