"""
Genera los datos con información de pose: 11 características base + 8 características de pose.
Será utilizado para el entrenamiento del modelo LSTM con información de pose.
Incluye aumento del horizonte.
"""
...
OBS_LEN = 8
PRED_LEN = 12
STRIDE = 3          # debe coincidir con obtain_downsampled_data.py
