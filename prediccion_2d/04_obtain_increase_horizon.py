"""
Crea el dataset submuestreado -> aumento del horizonte de predicción.
"""
...
OBS_LEN = 8
PRED_LEN = 12
STRIDE = 3          # 1 de cada 3 frames (ajustable)
...
if __name__ == "__main__":
    ...
    print(f"\nY (desplazamientos) — std: {Y.std():.4f}  (base era ~0.033; mayor = horizonte mayor)")
